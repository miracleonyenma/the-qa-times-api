...
export interface ApiAnswerAnswer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    images: Schema.Attribute.Relation<'morphMany'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::answer.answer'
...
export interface ApiStudentStudent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    studentinfo: Schema.Attribute.Relation<
      'oneToOne',
      'api::studentinfo.studentinfo'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiStudentinfoStudentinfo extends Struct.CollectionTypeSchema {
  collectionName: 'studentinfos';
  info: {
    displayName: 'studentinfo';
    pluralName: 'studentinfos';
    singularName: 'studentinfo';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::studentinfo.studentinfo': ApiStudentinfoStudentinfo;
